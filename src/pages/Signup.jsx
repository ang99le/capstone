...
<div class="flex min-h-full flex-col justify-center items-center w-[100%] h-[100vh] lg:h-[90vh] px-4 lg:px-8"  >
...
<img src="https://img.freepik.com/premium-vector/first-civilization-origin-ancient-sumerian-language-writing-clay-tablets-written-cuneiform_951778-26606.jpg" className="w-[580px] -ml-40" alt='sumerian people' />
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
        ...
        <div class="mt-2">
          <input id="text" name="text" type="text"  required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-800 sm:text-sm sm:leading-6 md:pl-48"/>
        </div>
      </div>
...
<div class="flex items-center">
    ...
    <label for="default-radio-2" class="ms-2 text-sm font-medium text-sky-800 dark:text-gray-300 -mt-4">Tourest</label>
      ...
      <div>
        <button type="submit" class="flex -mb-3 w-full justify-center rounded-md bg-sky-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">SignUp{' '}</button>
      </div>
      <div class="text-sm">
