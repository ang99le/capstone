...
function Events (){
  ...
  useEffect(() => {
    ...
    return (
     ...
     <section>
      <form className="flex justify-center mt-4 mb-3">
      <div>
    ...
    <div class="absolute inset-y-7 end-2 flex items-center ps-2 pointer-events-none">
      <img className="w-[25px]" src="https://img.icons8.com/?size=100&id=CxTiJN1kfPrR&format=png&color=FAB005" alt="location"></img>
                   ...
                   <div className="mt-2">
                     <input id="text" name="text" type="text" placeholder="select your location"  className="block w-full rounded-md border-0 py-2 text-sky-800 shadow-sm ring-1 ring-inset ring-yellow-500 placeholder:text-yellow-600 focus:ring-2 focus:ring-inset focus:ring-sky-300 sm:text-sm sm:leading-6 md:w-[350px] pl-2"></input>
                     
                   </div>                 </div>

                   <div class="relative inline-block text-left mt-2 ml-9">
  <div>
    <button type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-9 py-2.5 text-sm font-semibold text-yellow-600 shadow-sm ring-1 ring-inset ring-yellow-500 hover:bg-yellow-500" id="menu-button" aria-expanded="true" aria-haspopup="true">
     catogories
      <svg class="-mr-1 h-5 w-5 text-yellow-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
<div class="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-yellow-500 ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
    <div class="py-1" role="none">
      ...
      <form method="POST" action="#" role="none">
                   ...
                   <div date-rangepicker datepicker-autoselect-today class="flex items-center mt-1 ml-8">
  <div class="relative">
