...
<main>
<div class="flex min-h-full flex-col justify-center items-center w-[100%] h-[77vh] px-4  lg:px-8"  >
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="#" method="POST">
      ...
      <div class="text-sm">
            <a href="/SignUp" class="font-semibold text-sky-800 hover:text-sky-600">Don't have an account</a>
          </div>
    </form>
  </div>
</div>
