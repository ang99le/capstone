          ...
          <>
             {cardList.map((card, id) => (
              ...
              >
                ...
                <img src={card.img} alt="box_img" className="w-[250px] md:w-[293px] mb-4 flex flex-col cursor-pointer rounded-tl-[35px] rounded-br-[35px] shadow-2xl md:min-h-[340px]  card-item-div max-w-screen-md min-h-[260px] " />
                <p className="text-[24px] text-sky-800 font-bold uppercase mb-7">{t("{card.title}")}</p>
