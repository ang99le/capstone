...
<div class="p-8 mt-1 sm:mx-auto sm:w-full sm:max-w-sm md:mt-9">
  ...
  <div>
      ...
      <div class="mt-2">
        <input id="text" name="text" type="text"  required class="lg:w-[350px] pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-800 sm:text-sm sm:leading-6"/>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="mt-2">
        <input id="text" name="text" type="text"  required class="lg:w-[350px] block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-800 sm:text-sm sm:leading-6"/>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="mt-2">
        <input id="number" name="number" type="number"  required class="lg:w-[350px] pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-800 sm:text-sm sm:leading-6"/>
      </div>
    </div>
    ...
    <div>
      <button type="submit" class="mb-3 lg:w-[350px] flex w-full justify-center rounded-md bg-sky-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">Submit</button>
    </div>
